...
@Component({
  ...
  templateUrl: '../../pages/components/modals/client/modal-signup-client/modal-signup-client.component.html',
  styleUrls: ['../../pages/components/modals/client/modal-signup-client/modal-signup-client.component.css']
})
